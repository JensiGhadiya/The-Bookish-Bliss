  ...
  return (
    ...
    <div className='max-w-screen-2xl container mx-auto md:px-20 px-4 '>
      <div className='mt-28 items-center justify-center text-center'>
        ...
        <p className='mt-12'>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Nisi reprehenderit, rerum, dicta laboriosam architecto quos nam rem aliquam totam a ducimus neque veniam? Optio reprehenderit consequuntur facilis eius? Ipsum, totam.
