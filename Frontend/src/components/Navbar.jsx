...
function Navbar() {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 right-0 left-0  z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out" : ""}`}>
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">The Bookish Bliss</a>
  </div>
  ...
  <div className="">
    <a className="bg-black font-white px-3 py-2 rounded-md hover:bg-slat-800 duration-300 cursor-pointer">Login</a>
  </div>
  </div>
</div>
        </div>
